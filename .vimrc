...
"
" Most recent update: Sat Mar 02 16:12:48 CET 2019
"
...
"" vunlde lines from https://github.com/VundleVim/Vundle.vim
...
"Plugin 'PotatoesMaster/i3-vim-syntax', {'name': 'i3'}
...
"   Spellcheck
" ==============
" When to load                   Mask      activate          use lang
au BufNewFile,BufRead,BufEnter   *.md         setlocal spell    spelllang=en_us
au BufNewFile,BufRead,BufEnter   *COMMIT_EDITMSG*  setlocal spell    spelllang=en_us
